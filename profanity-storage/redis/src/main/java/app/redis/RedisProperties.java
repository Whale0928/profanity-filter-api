...
public record RedisProperties(String host, Main main, Sub sub // 이제 null 허용
    ) {
  public RedisProperties {
    if (host == null || host.isBlank()) throw new IllegalArgumentException("Redis 호스트 설정은 필수입니다");
  ...
  public record Main(int port, String password) {}

  public record Sub(List<Integer> port) {}
}
