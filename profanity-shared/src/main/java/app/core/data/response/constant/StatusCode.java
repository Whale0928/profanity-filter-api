...
public enum StatusCode {
  ...
  ADMIN_ACCESS_REQUIRED(4060, "관리자 권한이 필요합니다."),
  USER_NOT_FOUND(4061, "사용자를 찾을 수 없습니다."),
  USER_STATUS_CHANGE_FORBIDDEN(4062, "본인 계정과 관리자 계정은 비활성화할 수 없습니다."),
  WORD_NOT_FOUND(4063, "사전 단어를 찾을 수 없습니다."),
  WORD_ALREADY_EXISTS(4064, "이미 등록된 사전 단어입니다."),
  API_KEY_ALREADY_REVOKED(4065, "이미 폐기된 API Key입니다."),
  NEWS_NOT_FOUND(4080, "소식을 찾을 수 없습니다."),
  INQUIRY_NOT_FOUND(4081, "문의를 찾을 수 없습니다."),
  INQUIRY_ACCESS_DENIED(4082, "본인이 등록한 문의만 조회할 수 있습니다."),
  WORD_REQUEST_NOT_FOUND(4083, "문의에 연결된 단어 요청이 없습니다."),
